    ...
    <main className="mx-auto max-w-[1100px] px-4 md:px-8 py-10">
      ...
      <BrickCard accentTop="red" className="mb-6">
        ...
        <p className="type-body-sm text-slate-700 leading-relaxed">
          Once LEGO retires a set, primary supply is permanently capped. The only sealed
          inventory left is whatever is already in distribution. Demand keeps building from
          collectors, gifters, and new fandom waves, while the float keeps shrinking. That is
          why retired flagships have historically delivered the best LEGO returns. The
          trade-off: you are buying above MSRP and accepting whatever premium the secondary
          market has already priced in. We rank by composite score to surface the sets where
          the projected 5-year trajectory still justifies today&rsquo;s entry.
        </p>
      </BrickCard>
