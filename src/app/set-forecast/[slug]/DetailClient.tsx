...
import { SignalBadge, ConfidenceBadge } from "@/components/sets/SignalBadge";
import { ForecastChart } from "@/components/sets/ForecastChart";
import { RoiChart } from "@/components/sets/RoiChart";
import { ForecastBreakdownModal } from "@/components/sets/ForecastBreakdownModal";
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_2fr]">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="type-body-sm text-slate-500 leading-relaxed">
            ...
            <Link href="/set-forecast/methodology" className="text-bright-blue hover:underline underline-offset-2">
              How it works →
            </Link>
          </p>
        </div>
