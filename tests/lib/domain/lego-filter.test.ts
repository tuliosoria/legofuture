...
const makeItem = (overrides: {
  ...
  forecast: {
    ...
    scenarios: {
      pessimist: { projectedValue: 80, dollarGain: 30, roiPercent: 60, annualRate: 0.10, signal: "buy" },
      moderate: { projectedValue: 100, dollarGain: 50, roiPercent: 100, annualRate: 0.15, signal: "buy" },
      optimist: { projectedValue: 130, dollarGain: 80, roiPercent: 160, annualRate: 0.21, signal: "buy" },
    },
